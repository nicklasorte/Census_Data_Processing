function [cell_urban_area_data]=read_2020_urban_area_shapefile_rev2(app,uac20_folder,folder1)


cell_area_filename=strcat('cell_urban_area_data.mat');
...
% % %         temp_latlon=cell_urban_area_data{i,6}
% % %         temp_lon=cell_urban_area_data{i,4}
% % %         close all;
% % %         figure;
% % %         hold on;
% % % 
% % %         plot(temp_lon,cell_urban_area_data{i,3},'-k')
% % %         plot(temp_latlon(2),temp_latlon(1),'or')
% % % 
% % %         'Check'
% % %         pause;
