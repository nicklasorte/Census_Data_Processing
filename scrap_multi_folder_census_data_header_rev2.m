function [cell_data]=scrap_multi_folder_census_data_header_rev2(app,folder1,top_census_folder,filename_census_data,str_header_keep,data_header,tf_rescrap_shape,tf_rescrap_mat,idx_str2num)
...
if var_exist_block_cell==2
    ...
    for sub_idx=1:1:num_subfolders
        ...
        cell_data{sub_idx,2}=generic_scrap_census_cell_data_header_rev2(app,shape_folder,tf_rescrap_shape,data_header,str_header_keep,idx_str2num);
