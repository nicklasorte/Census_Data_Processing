function [array_census_data]=generic_scrap_census_array_data_rev1(app,shape_folder,tf_rescrap_shape,data_header,str_header_array_keep)
...
tic;
filename_array_shape_mat=strcat(data_header,'_array_',temp_split{1},'.mat');
